...
const CATEGORY_TO_CLINIC_TYPE: Record<string, string> = {
    ...
    const automationsLibrary: Automation[] = [
      ...
      { clinicType: ["universal"], name: "Birthday Greeting + 15% Offer", trigger_event: "birthday", action_type: "email", active: true },
      { clinicType: ["universal"], name: "Birthday SMS", trigger_event: "birthday", action_type: "sms", active: false },
      { clinicType: ["universal"], name: "No-Show Follow-Up", trigger_event: "no_show", action_type: "email", active: true },
